...
/* LED Check */
    ...
    //mcp.setup(0x20,0B00000000);   // I2C address 0x20; All GPIO port/pin are configured as output
    //mcp.setGPIOS(0B00000000); // Turns All GPIO LOW (pins 0 to 7)
    //mcp1.setup(0x21,0B11111111);   // I2C address 0x21; All GPIO port/pin are configured as intput
